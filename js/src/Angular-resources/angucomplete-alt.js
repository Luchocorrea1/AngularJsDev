...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', []).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate) {
    ...
    function link(scope, elem, attrs, ctrl) {
      ...
      unbindInitialValue = scope.$watch('currentModel', function (newval) {
        if (newval) {
      ...
      function callOrAssign(value) {
          ...
          if (scope.pkField && value && value.originalObject) {
              pkValue = value.originalObject[scope.pkField];
              if (scope.currentModel !== undefined)
                  scope.currentModel = pkValue;
          }
          if (typeof scope.selectedObject === 'function') {
              scope.selectedObject(value, scope.selectedObjectData, pkValue);
          }
          else {
