      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , resetToMinDate = function resetToMinDate() {
            $scope.mes = $filter('date')(new Date($scope.dateMinLimit), 'MMMM')
            $scope.month = $scope.mes == "January" ? "Enero": $scope.mes == "February" ? "Febrero": $scope.mes == "March" ? "Marzo": $scope.mes == "April" ? "Abril" : $scope.mes == "May" ? "Mayo" : $scope.mes == "June" ? "Junio" : $scope.mes == "July" ? "Julio" : $scope.mes == "August" ? "Agosto" : $scope.mes == "September" ? "Septiembre" : $scope.mes == "October" ? "Octubre" : $scope.mes == "November" ? "Noviembre": $scope.mes == "December"? "Diciembre": "Mes Inesperado";
          ...
          , resetToMaxDate = function resetToMaxDate() {
            ...
            $scope.mes = $filter('date')(new Date($scope.dateMaxLimit), 'MMMM');
            $scope.month = $scope.mes == "January" ? "Enero": $scope.mes == "February" ? "Febrero": $scope.mes == "March" ? "Marzo": $scope.mes == "April" ? "Abril" : $scope.mes == "May" ? "Mayo" : $scope.mes == "June" ? "Junio" : $scope.mes == "July" ? "Julio" : $scope.mes == "August" ? "Agosto" : $scope.mes == "September" ? "Septiembre" : $scope.mes == "October" ? "Octubre" : $scope.mes == "November" ? "Noviembre": $scope.mes == "December"? "Diciembre": "Mes Inesperado";
          ...
          , showCalendar = function showCalendar() {
            ...
            $timeout(function timeoutForYears() {
              ...
              $scope.mes = $filter('date')(new Date($scope.year, $scope.monthNumber - 1), 'MMMM');
              $scope.month = $scope.mes == "January" ? "Enero": $scope.mes == "February" ? "Febrero": $scope.mes == "March" ? "Marzo": $scope.mes == "April" ? "Abril" : $scope.mes == "May" ? "Mayo" : $scope.mes == "June" ? "Junio" : $scope.mes == "July" ? "Julio" : $scope.mes == "August" ? "Agosto" : $scope.mes == "September" ? "Septiembre" : $scope.mes == "October" ? "Octubre" : $scope.mes == "November" ? "Noviembre": $scope.mes == "December"? "Diciembre": "Mes Inesperado";
              setDaysInMonth($scope.monthNumber, $scope.year);
            }, 0);
          }
          ...
          , unregisterDataSetWatcher = $scope.$watch('dateSet', function dateSetWatcher(newValue) {
            ...
            if (newValue && !isNaN(Date.parse(newValue))) {
              ...
              $scope.mes = $filter('date')(date, 'MMMM');//december-November like
              $scope.month = $scope.mes == "January" ? "Enero": $scope.mes == "February" ? "Febrero": $scope.mes == "March" ? "Marzo": $scope.mes == "April" ? "Abril" : $scope.mes == "May" ? "Mayo" : $scope.mes == "June" ? "Junio" : $scope.mes == "July" ? "Julio" : $scope.mes == "August" ? "Agosto" : $scope.mes == "September" ? "Septiembre" : $scope.mes == "October" ? "Octubre" : $scope.mes == "November" ? "Noviembre": $scope.mes == "December"? "Diciembre": "Mes Inesperado";
        ...
        $scope.daysInString = ["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"];
