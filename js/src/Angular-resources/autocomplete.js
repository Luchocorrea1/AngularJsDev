  ...
  return {
    ...
    controller: ['$scope', function($scope){
      ...
      $scope.$watch('searchParam', function(newValue, oldValue){
        ...
        if ($scope.minLength !== undefined && newValue.length < $scope.minLength)
            return;
    ...
    link: function(scope, element, attrs){
      ...
      if (attrs.clickActivation) {
        element[0].onclick = function(e){
            if ((!scope.searchParam && scope.minLength=== undefined)||
                (scope.searchParam && scope.minLength !== undefined && scope.searchParam.length >= scope.minLength)) {
            setTimeout(function() {
              scope.completing = true;
              scope.$apply();
            }, 200);
